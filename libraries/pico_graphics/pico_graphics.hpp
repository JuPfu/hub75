...
namespace pimoroni
{
  ...
  struct RGB
  {
    ...
    constexpr RGB(RGB332 c) : r((c & 0b11100000) >> 0),
                                       g((c & 0b00011100) << 3),
                                       b((c & 0b00000011) << 6) {}
    constexpr RGB(RGB565 c) : r((__builtin_bswap16(c) & 0b1111100000000000) >> 8),
                                       g((__builtin_bswap16(c) & 0b0000011111100000) >> 3),
                                       b((__builtin_bswap16(c) & 0b0000000000011111) << 3) {}
    constexpr RGB(uint c) : r((c >> 16) & 0xff),
                                     g((c >> 8) & 0xff),
                                     b(c & 0xff) {}
    ...
    constexpr RGB &operator+=(const RGB &c)
    {
      r += c.r;
      g += c.g;
      b += c.b;
    ...
    int distance(const RGB &c) const
    {
      ...
      int gx = g - c.g;
      int bx = b - c.b;
      return abs((int)((((512 + rmean) * rx * rx) >> 8) + 4 * gx * gx + (((767 - rmean) * bx * bx) >> 8)));
    }
