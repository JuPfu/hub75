...
#define ROW_MAP_S31 2

#ifndef ROW_MAPPING
#define ROW_MAPPING 0
#endif

static_assert(ROW_MAPPING == ROW_MAP_STANDARD || ROW_MAPPING == ROW_MAP_SPLIT || ROW_MAPPING == ROW_MAP_S31, "Row mapping must be ROW_MAP_STANDARD, ROW_MAP_SPLIT, or ROW_MAP_S31");
